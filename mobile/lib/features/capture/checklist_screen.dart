...
class _ChecklistScreenState extends ConsumerState<ChecklistScreen> {
  ...
  Future<void> _captureDoc(String docType, String label,
  ...
  Future<void> _submit() async {
    ...
    if (!session.allDocsComplete) {
      setState(() => _submitError =
          'Please photograph all required supporting documents first.');
      return;
    }
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: FilledButton.icon(
                      ...
                      label: Text(session.allDocsComplete
                          ? 'Submit Bundle'
                          : 'Submit Anyway'),
